...
SEEDS = {
    ...
    "game_design": (True, [
        "design a game loop for my indie puzzle game",
        "balance the economy in my tabletop game",
        "level design for the first tutorial area",
        "playtest plan for the prototype",
        "game design doc for a cozy farming game",
        "mechanics for a deck builder without luck complaints",
    ]),
    "creative_art": (True, [
        "concept art direction for a fantasy book cover",
        "midjourney prompt for a cyberpunk street scene",
        "color palette for a calm meditation app",
        "logo brief for a coffee roastery",
        "character design for the game's villain",
        "mood board for the rebrand",
    ]),
    "academic": (True, [
        "help me solve this calculus problem",
        "chemistry study guide for the exam",
        "essay outline on the industrial revolution",
        "explain the history of the roman empire",
        "physics homework about projectile motion",
        "flashcards for biology midterm",
        "thesis statement for my term paper",
    ]),
    "investing": (True, [
        "evaluate nvidia as a long term investment",
        "dcf valuation for a company i might buy",
        "compare two etfs for my portfolio",
        "summarize the latest 10-k filing",
        "research the moat of a saas company",
        "balance sheet red flags to look for",
    ]),
    "research": (True, [
        "deep research on the standing desk market",
        "literature review on remote work productivity",
        "competitive analysis of meal kit companies",
        "fact check the claims in this article",
        "market research for a dog grooming business",
        "find sources on microplastics in drinking water",
    ]),
